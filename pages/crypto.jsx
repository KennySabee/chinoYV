    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid  md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4 p-4">
          ...
          <p>
            This app was built on React and shows current top 10 cryptocurrency
            quoter using an external api.
          </p>
          <div className="flex flex-col  mt-5 md:flex-row justify-start">
            <Link
              href="https://kenny-cotizadorcriptos.netlify.app/"
              target="_blank"
              className="md:mr-3"
            >
            ...
            <Link
              href="https://github.com/KennySabee/cotizadorCriptosProject"
              target="_blank"
            >
