    ...
    <div className="w-full">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          <h2 className="py-2">BUDGET CONTROL</h2>
          <h3> Vite</h3>
        </div>
      </div>
      <div className="max-w-[1240px] mx-auto p-2 grid  md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4 p-4">
          ...
          <p>
            This app was built on React it is a single page to manage a budget
            and test effects and states in React.
          </p>
          <div className="flex flex-col  mt-5 md:flex-row justify-start">
            <Link
              href="https://kenny-plannergastos.netlify.app/"
              target="_blank"
              className="md:mr-3"
            >
            ...
            <Link
              href="https://github.com/KennySabee/planGastosProject"
              target="_blank"
            >
