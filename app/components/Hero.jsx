    ...
    <section className="relative flex items-center justify-center h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1240px] px-4 text-white mx-auto flex flex-col justify-center items-center text-center">
        ...
        >
          ...
          >
            Somos una academia especializada en la enseñanza del chino mandarín
            y su cultura. Te preparamos para la certificación oficial HSK y
            ofrecemos oportunidades únicas de becas en China, abriendo puertas a
            tu futuro académico y laboral en el mundo.
          </motion.p>
        </motion.div>
        ...
        >
          <p className="text-white text-sm md:text-base">
            ...
            ¡Recibe nuestra asesoria gratuita para la obtención de becas
